...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='FullData',
                             help='fire | kitti | coco_hp | pascal')
    ...
    self.parser.add_argument('--num_workers', type=int, default=15,
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 1,
                'mean': [0.379,0.308, 0.264], 'std': [0.234,0.202,0.183],
                'dataset': 'FullData'},
